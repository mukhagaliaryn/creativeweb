    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_name', models.CharField(max_length=128, verbose_name='Полная имя')),
                ('avatar', models.ImageField(blank=True, null=True, upload_to='accounts/users/', verbose_name='Avatar')),
